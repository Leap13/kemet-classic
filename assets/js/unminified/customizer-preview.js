...
( function( $ ) {
	...
	kemet_responsive_spacing( 'kemet-settings[readmore-padding]','.content-area p.read-more a', 'padding', [ 'top', 'bottom', 'right', 'left' ] );
	...
	wp.customize( 'kemet-settings[topbar-bg-color]', function( value ) {
		value.bind( function( bg_obj ) {
			...
			var dynamicStyle = 'div.kmt-above-header { {{css}} }';
	...
	kemet_responsive_font_size( 'kemet-settings[topbar-font-size]', '.kmt-above-header');
	...
	wp.customize( 'kemet-settings[topbar-border-bottom-color]', function( value ) {
		value.bind( function( border_color ) {
			jQuery( '.kmt-above-header' ).css( 'border-color', border_color );
		} );
	} );
	/**
   ...
   kemet_css( 'kemet-settings[font-color-entry-title]', 'color', '.kmt-single-post .entry-title, .page-title' );
	...
	wp.customize( 'kemet-settings[footer-input-bg-color]', function( value ) {
		value.bind( function( bg_obj ) {
			
			var dynamicStyle = ' .footer-adv > input[type=text] { {{css}} }';
