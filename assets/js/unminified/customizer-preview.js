...
(function ($) {
	...
	wp.customize('kemet-settings[site-boxed-inner-bg]', function (value) {
		value.bind(function (bg_obj) {
			...
			var dynamicStyle = '.kmt-separate-container .kmt-article-post,.kmt-separate-container .kmt-article-single ,.kmt-separate-container .comment-respond ,.kmt-separate-container .kmt-author-box-info , .kmt-separate-container .kmt-woocommerce-container ,.kmt-separate-container .kmt-comment-list li ,.kmt-separate-container .comments-count-wrapper ,.kmt-separate-container.kmt-two-container div.widget , .kmt-separate-container .kmt-related { {{css}} }';
	...
	wp.customize('kemet-settings[content-separator-color]', function (value) {
		value.bind(function (border_color) {
			jQuery('body:not(.kmt-separate-container) .kmt-article-post > div,.kmt-separate-container .kmt-article-post ,body #primary,body #secondary, .single-post:not(.kmt-separate-container) .post-navigation ,.single-post:not(.kmt-separate-container) .comments-area ,.single-post:not(.kmt-separate-container) .kmt-author-box-info , .single-post:not(.kmt-separate-container) .comments-area .kmt-comment , .single-post:not(.kmt-separate-container) .kmt-related').css('border-color', border_color);
		});
	});
	/**
	 ...
	 */
	kemet_responsive_spacing('kemet-settings[container-inner-spacing]', '.kmt-separate-container .kmt-article-post, .kmt-separate-container .kmt-article-single, .kmt-separate-container .comment-respond, .single.kmt-separate-container .kmt-author-details, .kmt-separate-container .kmt-related-posts-wrap, .kmt-separate-container .kmt-woocommerce-container ,.single-post.kmt-separate-container .kmt-comment-list li , .kmt-separate-container .kmt-related', 'padding', ['top', 'bottom', 'right', 'left']);
