...
(function ($) {
  ...
  kemet_css(
    ...
    "text-transform",
    ".main-header-menu .sub-menu li a,.main-navigation .kemet-megamenu-item .kemet-megamenu .kemet-mega-menu-content"
  );
  kemet_responsive_slider(
  ...
  kemet_responsive_spacing(
    ...
    ".main-header-menu .sub-menu li > a , .kmt-header-break-point .main-navigation ul.children li > a , .kmt-header-break-point .main-navigation ul.sub-menu li > a ,.main-navigation .kemet-megamenu-item .kemet-megamenu .kemet-mega-menu-content",
    "padding",
    ["top", "bottom", "right", "left"]
  );
  ...
  wp.customize("kemet-settings[submenu-top-border-size]", function (setting) {
    setting.bind(function (border) {
      var dynamicStyle =
        ".main-header-menu ul.sub-menu , body:not(.kmt-header-break-point) #site-navigation .kemet-megamenu-item .mega-menu-full-wrap{ border-top-width: " +
        border +
        "px }";
      dynamicStyle +=
  ...
  wp.customize("kemet-settings[submenu-top-border-color]", function (value) {
    value.bind(function (color) {
      ...
      if (color) {
        var dynamicStyle =
          ".main-header-menu ul.sub-menu , body:not(.kmt-header-break-point) #site-navigation .kemet-megamenu-item .mega-menu-full-wrap{ border-top-color: " +
          color +
          "; } ";
  ...
  kemet_responsive_slider(
    ...
    ".main-header-menu .sub-menu li > a , .kmt-header-break-point .main-navigation ul.children li > a , .kmt-header-break-point .main-navigation ul.sub-menu li > a ,.main-navigation .kemet-megamenu-item .kemet-megamenu .kemet-mega-menu-content,.main-navigation .kemet-megamenu .heading-item>a",
    "font-size"
  );
  kemet_responsive_slider(
