...
(function ($) {
	...
	wp.customize('kemet-settings[site-boxed-inner-bg]', function (value) {
		value.bind(function (bg_obj) {
			...
			var dynamicStyle = '.kmt-separate-container .kmt-article-post,.single-post .comments-area ,.single-post.kmt-separate-container .kmt-author-box , .kmt-separate-container .kmt-article-single { {{css}} }';
