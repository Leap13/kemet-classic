const Icons = {
    row: {
        twocol: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2H32V37Zm62,0H34V2H64Z" />
            </svg>
        ),
        twoleftgolden: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2H41V37Zm62,0H43V2H64Z" />
            </svg>
        ),
        tworightgolden: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2H23V37Zm62,0H25V2H64Z" />
            </svg>
        ),
        threecol: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H65V0ZM2,37V2H21V37Zm40,0H23V2H42Zm21,0H44V2H63Z" />
            </svg>
        ),
        lefthalf: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2H32V37Zm32,0V2H48V37Zm30,0H50V2H64Z" />
            </svg>
        ),
        righthalf: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM16,37H2V2H16Zm16,0H18V2H32Zm32,0H34V2H64Z" />
            </svg>
        ),
        centerhalf: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2H16V37Zm16,0V2H48V37Zm46,0H50V2H64Z" />
            </svg>
        ),
        widecenter: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2H13V37Zm49,0H15V2H51Zm13,0H53V2H64Z" />
            </svg>
        ),
        fourcol: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2H16V37Zm16,0V2H32V37Zm16,0V2H48V37Zm30,0H50V2H64Z" />
            </svg>
        ),
        lfourforty: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2H28V37Zm28,0V2H40V37Zm12,0V2H52V37Zm22,0H54V2H64Z" />
            </svg>
        ),
        cfourforty: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2H12V37Zm12,0V2H32V37Zm20,0V2H52V37Zm30,0H54V2H64Z" />
            </svg>
        ),
        rfourforty: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2H12V37Zm12,0V2H24V37Zm12,0V2H36V37Zm38,0H38V2H64Z" />
            </svg>
        ),
        fivecol: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H67V0ZM2,37V2H13V37Zm24,0H15V2H26Zm13,0H28V2H39Zm13,0H41V2H52Zm13,0H54V2H65Z" />
            </svg>
        ),
        lfiveforty: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2H20V37Zm20,0V2h9V37Zm11,0V2h9V37Zm11,0V2h9V37Zm20,0H55V2h9Z" />
            </svg>
        ),
        cfiveforty: (
            <svg
                ...
                viewBox="0 0 66 39"
            >
                <path d="M0,0V39H66V0ZM2,37V2h8V37Zm10,0V2h8V37Zm10,0V2H44V37Zm24,0V2h8V37Zm18,0H56V2h8Z" />
            </svg>
        ),
        rfiveforty: (
            <svg
    ...
    "kmt-bag": (
        ...
        >
            <title>modern-bag-outline</title>
            <path
    ...
    "kmt-bag-fill": (
        <svg
            ...
            width="24"
            height="24"
            viewBox="0 0 17.37 19.53"
        >
            <title>modern-bag-fill</title>
            <path
                id="Modern_Bag_Fill"
                data-name="Modern Bag Fill"
                class="cls-1"
                d="M18.36,9.25,18.28,9a5.51,5.51,0,0,0-4.07-3.89,5,5,0,0,0-.06-1.69A4,4,0,0,0,10.89.32l-.12,0A4.43,4.43,0,0,0,9.23.3l-.12,0A4,4,0,0,0,5.85,3.39a5,5,0,0,0-.06,1.69A5.51,5.51,0,0,0,1.72,9l-.08.28A9.6,9.6,0,0,0,2,15.33l.1.23a6.47,6.47,0,0,0,5,3.92l.74.12a14,14,0,0,0,4.28,0l.74-.12a6.47,6.47,0,0,0,5-3.92l.1-.23A9.6,9.6,0,0,0,18.36,9.25ZM12.67,4.81a19.89,19.89,0,0,0-5.34,0,3.83,3.83,0,0,1,0-1.12,2.45,2.45,0,0,1,2-1.87l.12,0a2.69,2.69,0,0,1,1,0l.12,0a2.45,2.45,0,0,1,2,1.87A3.83,3.83,0,0,1,12.67,4.81Z"
                transform="translate(-1.31 -0.23)"
            />
        </svg>
    ),
    "kmt-dcart": (
