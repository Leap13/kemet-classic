			...
			self::$prefix . '-tabs' => array(
				...
				'tabs' => array(
					...
					'design'  => array(
						...
						'options' => array(
							self::$prefix . '-product-button' => array(
								'type'     => 'kmt-title',
								'priority' => 49,
								'label'    => __( 'Add to Cart Style', 'kemet' ),
							),
							self::$prefix . '-add-to-cart-typography' => array(
								'type'      => 'kmt-typography',
								'priority'  => 49,
								'transport' => 'postMessage',
								'label'     => __( 'Typography', 'kemet' ),
								'preview'   => array(
									'selector' => '.woocommerce div.product form.cart .button.single_add_to_cart_button, .woocommerce-page div.product form.cart .button.single_add_to_cart_button',
								),
							),
						),
					),
