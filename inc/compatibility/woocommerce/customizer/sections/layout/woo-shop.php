 ...
 */
$wp_customize->add_setting(
    KEMET_THEME_SETTINGS . '[product-title-spacing]', array(
...
$wp_customize->add_control(
    new Kemet_Control_Responsive_Spacing(
        $wp_customize, KEMET_THEME_SETTINGS . '[product-title-spacing]', array(
 ...
 */
$wp_customize->add_setting(
    KEMET_THEME_SETTINGS . '[product-price-spacing]', array(
...
$wp_customize->add_control(
    new Kemet_Control_Responsive_Spacing(
        $wp_customize, KEMET_THEME_SETTINGS . '[product-price-spacing]', array(
            'type' => 'kmt-responsive-spacing',
            'section' => 'woocommerce_product_catalog',
            'priority' => 39,
            'label' => __('Spacing', 'kemet'),
 ...
 */
$wp_customize->add_setting(
    KEMET_THEME_SETTINGS . '[product-rating-font-size]', array(
...
$wp_customize->add_control(
    new Kemet_Control_Responsive_Slider(
        $wp_customize, KEMET_THEME_SETTINGS . '[product-rating-font-size]', array(
 ...
 */
$wp_customize->add_setting(
    KEMET_THEME_SETTINGS . '[product-rating-spacing]', array(
...
$wp_customize->add_control(
    new Kemet_Control_Responsive_Spacing(
        $wp_customize, KEMET_THEME_SETTINGS . '[product-rating-spacing]', array(
            'type' => 'kmt-responsive-spacing',
            'section' => 'woocommerce_product_catalog',
            'priority' => 39,
            'label' => __('Spacing', 'kemet'),
