...
$wp_customize->add_control(
	new Kemet_Control_Title(
		$wp_customize,
		KEMET_THEME_SETTINGS . '[kmt-cart-dropdown-title]',
		array(
			'type'     => 'kmt-title',
...
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[shop-cart-icon]',
	array(
 ...
 */
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[cart-icon-display]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[cart-icon-size]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[cart-icon-center-vertically]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[cart-dropdown-width]',
	array(
 ...
 */
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[cart-dropdown-bg-color]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[cart-dropdown-border-size]',
	array(
 ...
 */
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[cart-dropdown-border-color]',
	array(
