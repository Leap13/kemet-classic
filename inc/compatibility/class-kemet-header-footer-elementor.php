<?php
/**
 * Elementor Header Footer Compatibility File.
 *
 * @package Kemet
 */
 ...
 */
class Kemet_Header_Footer_Elementor {
	...
	public function __construct() {
		...
		remove_action( 'init', array( \Header_Footer_Elementor::instance(), 'setup_unsupported_theme' ) ); // phpcs:ignore
	}
...
new Kemet_Header_Footer_Elementor();
