...
if ( ! function_exists( 'wiz_single_body_class' ) ) {
	...
	function wiz_single_body_class( $classes ) {
		...
		// Blog layout.
		if ( is_single() ) {
			$classes[] = 'wiz-blog-single-style-1';

			if ( 'post' != get_post_type() ) {
				$classes[] = 'wiz-custom-post-type';
			}
		}

		if ( is_singular() ) {
			$classes[] = 'wiz-single-post';
		}
		...
		switch ( $comment->comment_type ) {
			...
			default:
				...
				<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
					...
					<article id="comment-<?php comment_ID(); ?>" class="wiz-comment">
						<div class='wiz-comment-avatar-wrap'><?php echo get_avatar( $comment, 50 ); ?></div><!-- Remove 1px Space
						--><div class="wiz-comment-data-wrap">
							<div class="wiz-comment-meta-wrap">
								<header class="wiz-comment-meta wiz-row wiz-comment-author vcard capitalize">
									...
									printf(
										'<div class="wiz-comment-cite-wrap wiz-col-lg-12"><cite><b class="fn">%1$s</b> %2$s</cite></div>',
										get_comment_author_link(),
										// If current post author is also comment author, make it known visually.
										( $comment->user_id === $post->post_author ) ? '<span class="wiz-highlight-text wiz-cmt-post-author"></span>' : ''
									);

									printf(
										'<div class="wiz-comment-time wiz-col-lg-12"><span  class="timendate"><a href="%1$s"><time datetime="%2$s">%3$s</time></a></span></div>',
							...
							<section class="wiz-comment-content comment">
								...
								<div class="wiz-comment-edit-reply-wrap">
									<?php edit_comment_link( wiz_theme_strings( 'string-comment-edit-link', false ), '<span class="wiz-edit-link">', '</span>' ); ?>
									<?php
									comment_reply_link(
										array_merge(
											$args, array(
												...
												'before' => '<span class="wiz-reply-link">',
												'after'  => '</span>',
											)
										)
									);
								...
								<?php if ( '0' == $comment->comment_approved ) : ?>
									<p class="wiz-highlight-text comment-awaiting-moderation"><?php echo esc_html( wiz_theme_strings( 'string-comment-awaiting-moderation', false ) ); ?></p>
								<?php endif; ?>
