...
if ( ! class_exists( 'Kemet_Fonts_Data' ) ) :
	...
	final class Kemet_Fonts_Data {
		...
		public static function js() {
			...
			$system = wp_json_encode( Kemet_Font_Families::get_system_fonts() );
			$google = wp_json_encode( Kemet_Font_Families::get_google_fonts() );
			$custom = wp_json_encode( Kemet_Font_Families::get_custom_fonts() );
			if ( ! empty( $custom ) ) {
