...
$wp_customize->add_control(
	new Kemet_Control_Title(
		$wp_customize,
		KEMET_THEME_SETTINGS . '[kmt-site-logo-title]',
		array(
			'type'     => 'kmt-title',
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[tagline-color]',
	array(
...
$wp_customize->add_control(
	new Kemet_Control_Title(
		$wp_customize,
		KEMET_THEME_SETTINGS . '[kmt-site-logo-settings]',
		array(
			'type'     => 'kmt-title',
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[kmt-header-retina-logo]',
	array(
...
$wp_customize->add_control(
	new Kemet_Control_Title(
		$wp_customize,
		KEMET_THEME_SETTINGS . '[kmt-site-icon-title]',
		array(
			'type'     => 'kmt-title',
