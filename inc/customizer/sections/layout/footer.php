...
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[copyright-footer-layout]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[footer-copyright-section-1]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[footer-copyright-section-1-part]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[footer-copyright-section-2]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[footer-copyright-section-2-part]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[footer-layout-width]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[kmt-footer-bar-title]',
	array(
		'dependency'        => array(
			'controls'   => KEMET_THEME_SETTINGS . '[copyright-footer-layout]',
			'conditions' => '!=',
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[footer-copyright-divider]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[footer-copyright-divider-color]',
	array(
...
*/
$wp_customize->add_setting(
	KEMET_THEME_SETTINGS . '[kmt-footer-bar-content-title]',
	array(
		'dependency'        => array(
			'controls'   => KEMET_THEME_SETTINGS . '[copyright-footer-layout]',
			'conditions' => '!=',
