...
$wp_customize->add_setting(
    KEMET_THEME_SETTINGS . '[font-size-page-meta]', array(
        'default'           => $defaults[ 'font-size-page-meta' ],
        'type'              => 'option',
        'transport'         => 'postMessage',
        'sanitize_callback' => array( 'Kemet_Customizer_Sanitizes', 'sanitize_responsive_slider' ),
    )
...
$wp_customize->add_control(
    new Kemet_Control_Color(
        $wp_customize, KEMET_THEME_SETTINGS . '[overlay-icon-h-color]', array(
            'label'   => __( 'Overlay Icon Hover Color', 'kemet' ),
            'priority'       => 135,
            'section' => 'section-blog',
        )
    )
...
$wp_customize->add_control(
    new Kemet_Control_Color(
        $wp_customize, KEMET_THEME_SETTINGS . '[overlay-icon-bg-color]', array(
            'section'  => 'section-blog',
            'priority' => 140,
            'label'    => __( 'Overlay Icon Background Color', 'kemet' ),
        )
    )
);
/**
...
$wp_customize->add_control(
    new Kemet_Control_Color(
        $wp_customize, KEMET_THEME_SETTINGS . '[overlay-icon-bg-h-color]', array(
            'section'  => 'section-blog',
            'priority' => 145,
            'label'    => __( 'Overlay Icon Background Hover Color', 'kemet' ),
        )
    )
);