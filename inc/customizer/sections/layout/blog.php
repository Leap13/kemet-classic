	...
	$wp_customize->add_control(
		new Kemet_Control_Sortable(
			$wp_customize, KEMET_THEME_SETTINGS . '[blog-post-structure]', array(
				...
				'active_callback' => 'kmt_dep_thumbnail',
			)
		)
	);
    ...
    */
    ...
    $wp_customize->add_setting(
        KEMET_THEME_SETTINGS . '[blog-style]',array(
            'default'           => kemet_get_option('blog-style'),
            'type'              => 'option',
            'sanitize_callback' => array('Kemet_Customizer_Sanitizes','sanitize_choices')
        )
    );
    $wp_customize->add_control(
        KEMET_THEME_SETTINGS . '[blog-style]' ,array(
            ...
            'choices'    => array(
                'large'         => __( 'Large Image', 'kemet' ),
                'grid'          => __( 'Grid', 'kemet' ),
				'thumbnail'     => __( 'Thumbnail', 'kemet' ),
			),
        )
	);
	 ...
	 */
	$wp_customize->add_setting(
		KEMET_THEME_SETTINGS . '[blog-grid]', array(
			'default'           => kemet_get_option( 'blog-grid' ),
			'type'              => 'option',
			'sanitize_callback' => array( 'Kemet_Customizer_Sanitizes', 'sanitize_choices' ),
		)
	);
	$wp_customize->add_control(
		KEMET_THEME_SETTINGS . '[blog-grid]', array(
			...
			'choices'  => array(
				...
				'4'  => __( '3 Columns', 'kemet' ),
				'3'  => __( '4 Columns', 'kemet' ),
			),
