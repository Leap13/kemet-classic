...
if ( ! defined( 'ABSPATH' ) ) {
	exit;
           ...
           /**
            * Option: Links Hover Color
            */
           $wp_customize->add_setting(
               KEMET_THEME_SETTINGS . '[sidebar-links-h-color]', array(
                   'default'           => '',
                   'type'              => 'option',
                   'transport'         => 'postMessage',
                   'sanitize_callback' => array( 'Kemet_Customizer_Sanitizes', 'sanitize_hex_color' ),
           ...
           $wp_customize->add_control(
               new WP_Customize_Color_Control(
                   $wp_customize, KEMET_THEME_SETTINGS . '[sidebar-links-h-color]', array(
                       'label'   => __( 'Links Hover Color', 'kemet' ),
                       'priority'       => 1,
                       'section' => 'section-sidebars',
                   )
               )
