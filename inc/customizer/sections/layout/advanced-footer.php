...
if ( ! defined( 'ABSPATH' ) ) {
	 ...
	 */
	$wp_customize->add_setting(
		KEMET_THEME_SETTINGS . '[footer-border-color]', array(
			'default'           => '#7a7a7a',
			'type'              => 'option',
			'transport'         => 'postMessage',
			'sanitize_callback' => array( 'Kemet_Customizer_Sanitizes', 'sanitize_hex_color' ),
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			$wp_customize, KEMET_THEME_SETTINGS . '[footer-border-color]', array(
				'section'  => 'section-footer-adv',
				'priority' => 26,
				'label'    => __( 'Footer Border Color', 'kemet' ),
			)
		)
	);
	...
	$wp_customize->add_control(
         ...
         */
        $wp_customize->add_setting(
            KEMET_THEME_SETTINGS . '[footer-spacing]', array(
                'default'           => kemet_get_option( 'footer-spacing' ),
                'type'              => 'option',
                'transport'         => 'postMessage',
        ...
        $wp_customize->add_control(
            new Kemet_Control_Responsive_Spacing(
                $wp_customize, KEMET_THEME_SETTINGS . '[footer-spacing]', array(
