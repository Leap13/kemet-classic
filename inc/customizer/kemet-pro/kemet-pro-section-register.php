<?php
/**
 * Register customizer Kemet Pro Section.
 *
 * @package   Kemet
 * @author    Kemet
...
$wp_customize->add_section(
	new Kemet_Pro_Customizer(
		$wp_customize, 'kemet-pro', array(
			...
			'pro_url'  => wp_specialchars_decode( kemet_get_pro_url( 'https://wpkemet.com/pricing/', 'customizer', 'upgrade-link', 'upgrade-to-pro' ) ),
			'priority' => 1,
		)
	)
);
