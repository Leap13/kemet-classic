 ...
 * @since 1.4.3
 */
if ( ! class_exists( 'Kemet_Customizer_Control_Base' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class Kemet_Customizer_Control_Base {
		...
		public static function add_control( $name, $atts ) {
			...
			if ( 'Kemet_Control_Typography' !== $atts['callback'] ) {
				/**
				 * Register controls
				 */
 ...
 */
new Kemet_Customizer_Control_Base;
