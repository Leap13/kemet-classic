...
/* harmony import */ var react_color_lib_helpers_color__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! react-color/lib/helpers/color */ "./node_modules/react-color/lib/helpers/color.js");
/* harmony import */ var react_color_lib_helpers_color__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(react_color_lib_helpers_color__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var react_color_lib_components_common__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! react-color/lib/components/common */ "./node_modules/react-color/lib/components/common/index.js");
/* harmony import */ var react_color_lib_components_common__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(react_color_lib_components_common__WEBPACK_IMPORTED_MODULE_8__);
...
var PickerFields = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(PickerFields, _Component);

  var _super = _createSuper(PickerFields);

  function PickerFields(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, PickerFields);

    _this = _super.call(this, props);
    _this.toggleViews = _this.toggleViews.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2___default()(_this));
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(PickerFields, [{
    key: "toggleViews",
    ...
    key: "handleChange",
    value: function handleChange(data, e) {
      if (data.hex) {
        react_color_lib_helpers_color__WEBPACK_IMPORTED_MODULE_7___default.a.isValidHex(data.hex) && this.props.onChange({
          hex: data.hex,
          source: 'hex'
        }, e);
      } else if (data.r || data.g || data.b) {
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
        ...
        style: styles.double
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(react_color_lib_components_common__WEBPACK_IMPORTED_MODULE_8__["EditableInput"], {
        style: {
          input: styles.input,
          label: styles.label
        },
        ...
        onChange: this.handleChange
      })), this.state.view === 'rgb' && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
        style: styles.single
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(react_color_lib_components_common__WEBPACK_IMPORTED_MODULE_8__["EditableInput"], {
        style: {
          input: styles.input,
        ...
        arrowOffset: 0.01,
        onChange: this.handleChange
      }))), this.state.view === 'hsl' && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
        style: styles.single
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(react_color_lib_components_common__WEBPACK_IMPORTED_MODULE_8__["EditableInput"], {
        style: {
          input: styles.input,
...
/* harmony default export */ __webpack_exports__["default"] = (PickerFields);
...
/* harmony import */ var _colorPicker__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./colorPicker */ "./src/common/colorPicker.js");
...
var KemetColorPickerControl = /*#__PURE__*/function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(KemetColorPickerControl, [{
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("div", {
      ...
      }), 'image' === backgroundType && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["ColorIndicator"], {
        className: "kemet-advanced-color-indicate",
        colorValue: "#ffffff"
        ...
        if (tab.name) {
          ...
          if ('image' === tab.name) {
            ...
            tabout = Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["Fragment"], null, refresh && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_colorPicker__WEBPACK_IMPORTED_MODULE_10__["default"], {
              color: _this2.state.isPalette && _this2.state.palette.palette && _this2.state.palette.palette[parseInt(_this2.state.color.slice(-1), 10) - 1] ? _this2.state.palette.palette[parseInt(_this2.state.color.slice(-1), 10) - 1].color : _this2.state.color,
              onChange: function onChange(color) {
                return _this2.onChangeState(color, '');
              },
              onChangeComplete: function onChangeComplete(color) {
                return _this2.onChangeComplete(color, '');
              }
            })), !refresh && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_colorPicker__WEBPACK_IMPORTED_MODULE_10__["default"], {
              color: _this2.state.isPalette && _this2.state.palette.palette && _this2.state.palette.palette[parseInt(_this2.state.color.slice(-1), 10) - 1] ? _this2.state.palette.palette[parseInt(_this2.state.color.slice(-1), 10) - 1].color : _this2.state.color,
              onChange: function onChange(color) {
                return _this2.onChangeState(color, '');
              },
            ...
            })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["ColorPalette"], {
              colors: finalpaletteColors,
              value: _this2.props.color,
              clearable: false,
    ...
    value: function renderImageSettings() {
      ...
      }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_media_utils__WEBPACK_IMPORTED_MODULE_11__["MediaUpload"], {
...
/***/ "./src/common/colorPicker.js":
/*!***********************************!*\
  !*** ./src/common/colorPicker.js ***!
  \***********************************/
/*! exports provided: KemetColorPicker, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "KemetColorPicker", function() { return KemetColorPicker; });
...
/* harmony import */ var react_color_lib_components_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-color/lib/components/common */ "./node_modules/react-color/lib/components/common/index.js");
...
/* harmony import */ var react_color_lib_components_chrome_ChromePointerCircle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-color/lib/components/chrome/ChromePointerCircle */ "./node_modules/react-color/lib/components/chrome/ChromePointerCircle.js");
/* harmony import */ var react_color_lib_components_chrome_ChromePointerCircle__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react_color_lib_components_chrome_ChromePointerCircle__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var react_color_lib_components_chrome_ChromePointer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react-color/lib/components/chrome/ChromePointer */ "./node_modules/react-color/lib/components/chrome/ChromePointer.js");
/* harmony import */ var react_color_lib_components_chrome_ChromePointer__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_color_lib_components_chrome_ChromePointer__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _PickerFields__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./PickerFields */ "./src/common/PickerFields.js");
...
var KemetColorPicker = function KemetColorPicker(_ref) {
  var rgb = _ref.rgb,
      hex = _ref.hex,
      hsv = _ref.hsv,
      hsl = _ref.hsl,
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    style: styles.picker,
    className: "Kemet-picker"
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    style: styles.saturation
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react_color_lib_components_common__WEBPACK_IMPORTED_MODULE_2__["Saturation"], {
    style: styles.Saturation,
    hsl: hsl,
    hsv: hsv,
    pointer: react_color_lib_components_chrome_ChromePointerCircle__WEBPACK_IMPORTED_MODULE_3__["ChromePointerCircle"],
    onChange: onChange
  })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    style: styles.body
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    ...
    style: styles.hue
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react_color_lib_components_common__WEBPACK_IMPORTED_MODULE_2__["Hue"], {
    style: styles.Hue,
    hsl: hsl,
    onChange: onChange,
    pointer: react_color_lib_components_chrome_ChromePointer__WEBPACK_IMPORTED_MODULE_4__["ChromePointer"]
  })), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    style: styles.alpha
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react_color_lib_components_common__WEBPACK_IMPORTED_MODULE_2__["Alpha"], {
    style: styles.Alpha,
    rgb: rgb,
    hsl: hsl,
    renderers: renderers,
    ...
    style: styles.color
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react_color_lib_components_common__WEBPACK_IMPORTED_MODULE_2__["Checkboard"], null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    style: styles.activeColor
  })))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_PickerFields__WEBPACK_IMPORTED_MODULE_5__["default"], {
    rgb: rgb,
    hsl: hsl,
    hex: hex,
    onChange: onChange
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_color__WEBPACK_IMPORTED_MODULE_1__["CustomPicker"])(KemetColorPicker));
...
var ColorComponent = function ColorComponent(props) {
  ...
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("label", null, labelHtml, descriptionHtml), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])("div", {
...
/*!******************************************!*\
  !*** ./src/options/options-component.js ***!
  \******************************************/
/*! exports provided: renderOptions, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _kmt_controls_color__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../kmt-controls/color */ "./src/kmt-controls/color.js");
/* harmony import */ var _kmt_controls_responsive_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../kmt-controls/responsive-slider */ "./src/kmt-controls/responsive-slider.js");
...
/* harmony import */ var _kmt_controls_select__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../kmt-controls/select */ "./src/kmt-controls/select.js");
/* harmony import */ var _kmt_controls_title__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../kmt-controls/title */ "./src/kmt-controls/title.js");
...
var OptionComponent = function OptionComponent(type) {
  ...
  switch (type) {
    case 'kmt-color':
      OptionComponent = _kmt_controls_color__WEBPACK_IMPORTED_MODULE_3__["default"];
      break;
    ...
    case 'kmt-responsive-slider':
      OptionComponent = _kmt_controls_responsive_slider__WEBPACK_IMPORTED_MODULE_4__["default"];
      break;
    ...
    case 'kmt-select':
      OptionComponent = _kmt_controls_select__WEBPACK_IMPORTED_MODULE_7__["default"];
      break;

    case 'kmt-title':
      OptionComponent = _kmt_controls_title__WEBPACK_IMPORTED_MODULE_8__["default"];
      break;
  }
...
var renderOptions = function renderOptions(options) {
  return Object.keys(options).map(function (optionId) {
    var controlName = KemetCustomizerData.setting.replace("setting_name", optionId);
    var control = wp.customize(controlName);
    var option = options[optionId];
    var display = option.context ? isDisplay(option.context) : true;
    ...
    if (option.type && display) {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("li", {
        ...
        onChange: function onChange(key, value) {
          key = KemetCustomizerData.setting.replace("setting_name", key);
...
var OptionsComponent = function OptionsComponent(_ref) {
