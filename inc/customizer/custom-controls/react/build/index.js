...
var BackgroundComponent = function BackgroundComponent(props) {
  ...
  var updateValue = function updateValue(obj) {
    ...
    if (responsive) {
      props.control.setting.set(_objectSpread(_objectSpread(_objectSpread({}, props.control.setting.get()), obj), {}, {
...
wp.customize.controlConstructor['kmt-group'] = _color_group_control__WEBPACK_IMPORTED_MODULE_16__["colorGroupControl"]; // wp.customize.controlConstructor['kmt-typo'] = TypographyControl;
