 ...
 * @since 2.6.0
 */
export const coreControl = (wp.customize.kemetControl = wp.customize.Control.extend(
  {
    /**
    ...
    actuallyEmbed: function () {
      ...
      if (control?.params?.divider?.kmt_title) {
        control.container.prepend(
          '<label class="kmt-divider-title">' +
            control.params.divider.kmt_title +
            "</label>"
        );
      }
