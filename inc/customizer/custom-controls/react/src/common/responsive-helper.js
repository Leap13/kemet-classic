export function kemetGetResponsiveJs(control) {
    ...
    jQuery(document)
        .find(".kmt-responsive-control-btns > li")
        .removeClass("active");
    jQuery(document)
        .find(".kmt-responsive-control-btns > li." + device)
        .addClass("active");
    jQuery(document)
...
export function kemetGetResponsiveBgJs(control, child_control_name) {
    ...
    jQuery(
        ".customize-control-kmt-responsive-background .customize-control-content .background-container"
    ).removeClass("active");
    ...
    jQuery(
        ".customize-control-kmt-responsive-background .kmt-responsive-btns li"
    ).removeClass("active");
...
export function KemetGetResponsiveColorGroupJs(control, child_control_name) {
    ...
    jQuery(
        ".customize-control-kmt-color-group .kmt-field-color-group-wrap .kmt-color-group-responsive-wrap"
    ).removeClass("active");
    ...
    jQuery(
        ".customize-control-kmt-color-group .kmt-responsive-btns li"
    ).removeClass("active");

    jQuery(
        ".customize-control-kmt-color-group .kmt-responsive-btns li." + device
    ).addClass("active");
