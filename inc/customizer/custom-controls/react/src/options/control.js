...
const renderOptions = (control) => {
  ...
  document.dispatchEvent(
    new CustomEvent("kmtOptionsReady", {
      detail: control,
    })
  );
      ...
      $(".wp-full-overlay-sidebar-content, .wp-picker-container").click(
        function (e) {
          if (
            ...
            $(".components-button.kemet-color-icon-indicate.open").trigger(
              "click"
            );
          }
        }
        ...
        function () {
          ...
          if ($this.hasClass("open")) {
            ...
            var getOpenPopup = Section.find(
              ".components-button.kemet-color-icon-indicate.open"
            );
