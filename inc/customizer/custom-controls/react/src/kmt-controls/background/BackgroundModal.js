                    ...
                    <MediaUpload
                        ...
                        render={({ open }) => (
                            <>
                                {!props.media &&
                                    <div className="kmt-control kmt-image-actions">
                                        < Button className="upload-button button-add-media" isDefault onClick={() => openMedia(open)}>
                                ...
                                {(props.media && props.backgroundType === "image") &&
                                    <div className="actions">
                                        ...
                                        <Button type="button" className="button edit-image" onClick={() => openMedia(open)}>
                                        </Button>
                                    </div>}
                            </>
                        )}
                            ...
                            {Object.keys(repeat).map((item) => {
                                ...
                                return (
                                    <li
                                        ...
                                        onClick={() =>
                                            props.onChangeImageOptions("background-repeat", item, "image")
                                        }
                                    >
                            ...
                            {["auto", "cover", "contain"].map((item) => {
                                ...
                                return (
                                    <li
                                        ...
                                        className={`${classActive}`}
                                        onClick={() =>
                                            props.onChangeImageOptions("background-size", item, "image")
                                        }
                                    >
                                        {item}
                                    </li>
