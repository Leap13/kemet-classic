...
class Kemet_Control_Responsive_Icon_Select extends WP_Customize_Control {
    ...
    * export custom variables by overriding {
        ...
        */
		...
		<div id="input_{{ data.id }}" class="desktop active responsive-icon-select <?php echo $rtl_class; ?>" data-device="desktop">  
        ...
        <div id="input_{{ data.id }}" class="tablet responsive-icon-select <?php echo $rtl_class; ?>" data-device="tablet">  
			<# for ( key in data.choices ) { #>	
				<label>
        ...
        <div id="input_{{ data.id }}" class="mobile responsive-icon-select <?php echo $rtl_class; ?>" data-device="mobile">  
			<# for ( key in data.choices ) { #>	
				<label>
