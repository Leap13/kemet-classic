...
if ( ! class_exists( 'Kemet_Customizer' ) ) {
	...
	class Kemet_Customizer {
		...
		public function customize_register( $wp_customize ) {
			...
			require KEMET_THEME_DIR . 'inc/customizer/sections/layout/footer/class-kemet-footer-button-customizer.php';
			...
			//require KEMET_THEME_DIR . 'inc/customizer/sections/layout/footer/class-kemet-footer-html-customizer.php';
