...
<div class="<?php echo esc_attr( $classes ); ?>">
	<div class="footer-adv-overlay">
		<div class="kmt-container">
			<div class="kmt-row">
				<div class="kmt-col-lg-3 ast-col-md-3 ast-col-sm-12 ast-col-xs-12 footer-adv-widget footer-adv-widget-1">
					<?php kemet_get_footer_widget( 'advanced-footer-widget-1' ); ?>
				</div>
				<div class="kmt-col-lg-3 ast-col-md-3 ast-col-sm-12 ast-col-xs-12 footer-adv-widget footer-adv-widget-2">
					<?php kemet_get_footer_widget( 'advanced-footer-widget-2' ); ?>
				</div>
				<div class="kmt-col-lg-3 ast-col-md-3 ast-col-sm-12 ast-col-xs-12 footer-adv-widget footer-adv-widget-3">
					<?php kemet_get_footer_widget( 'advanced-footer-widget-3' ); ?>
				</div>
				<div class="kmt-col-lg-3 ast-col-md-3 ast-col-sm-12 ast-col-xs-12 footer-adv-widget footer-adv-widget-4">
