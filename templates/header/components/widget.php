...
$widget = $widget['type'];
?>
<div class="kmt-header-item kmt-<?php echo esc_attr( $widget ); ?>-item kmt-item-focus" data-section="<?php echo kemet_has_widget_editor() ? 'kemet-sidebar-widgets-' . $widget : 'sidebar-widgets-' . $widget; ?>">
