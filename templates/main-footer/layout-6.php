...
<div class="<?php echo esc_attr( $classes ); ?>">
	<div class="wiz-footer-overlay">
		<div class="wiz-container">
			<div class="wiz-row">
				<div class="wiz-col-lg-2 wiz-col-md-2 wiz-col-sm-12 wiz-col-xs-12 wiz-footer-widget wiz-footer-widget-1">
					<?php wiz_get_footer_widget( 'main-footer-widget-1' ); ?>
				</div>
				<div class="wiz-col-lg-2 wiz-col-md-2 wiz-col-sm-12 wiz-col-xs-12 wiz-footer-widget wiz-footer-widget-2">
					<?php wiz_get_footer_widget( 'main-footer-widget-2' ); ?>
				</div>
				<div class="wiz-col-lg-2 wiz-col-md-2 wiz-col-sm-12 wiz-col-xs-12 wiz-footer-widget wiz-footer-widget-3">
					<?php wiz_get_footer_widget( 'main-footer-widget-3' ); ?>
				</div>
				<div class="wiz-col-lg-2 wiz-col-md-2 wiz-col-sm-12 wiz-col-xs-12 wiz-footer-widget wiz-footer-widget-4">
					<?php wiz_get_footer_widget( 'main-footer-widget-4' ); ?>
				</div>
                <div class="wiz-col-lg-2 wiz-col-md-2 wiz-col-sm-12 wiz-col-xs-12 wiz-footer-widget wiz-footer-widget-5">
					<?php wiz_get_footer_widget( 'main-footer-widget-5' ); ?>
				</div>
			</div><!-- .wiz-row -->
		</div><!-- .wiz-container -->
	</div><!-- .wiz-footer-overlay-->
</div><!-- .wiz-theme-footer .wiz-footer-layout-5 -->
