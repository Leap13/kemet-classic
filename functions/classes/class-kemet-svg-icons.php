		...
		$output = '';
			switch ( $icon ) {
				...
				case 'search':
					...
					break;
				case 'author':
					$output = '<svg data-name="Layer 1" viewBox="0 0 86.5 90" xmlns="http://www.w3.org/2000/svg">
					...
					break;
				case 'category':
					$output = '<svg data-name="Layer 1" viewBox="0 0 89.91 71.1" xmlns="http://www.w3.org/2000/svg">
					...
					break;
				case 'comment':
					$output = '<svg data-name="Layer 1" viewBox="0 0 90 69" xmlns="http://www.w3.org/2000/svg">
					...
					break;
				case 'tags':
					$output = '<svg data-name="Layer 1" viewBox="0 0 90 90" xmlns="http://www.w3.org/2000/svg">
					...
					break;
				case 'date':
					$output = '<svg data-name="Layer 1" viewBox="0 0 90 84.3" xmlns="http://www.w3.org/2000/svg">
