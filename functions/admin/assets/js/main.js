  ...
  if (activateButton) {
    activateButton.addEventListener("click", function (event) {
      ...
      if (status == "activate") {
        ...
        deactivate_url = kemet_active_plugin.getAttribute(
          "data-url-deactivate"
        );
      ...
      function deactivate(url) {
        ...
        xhr.onreadystatechange = function () {
          ...
          kemet_active_plugin.innerHTML =
            '<span class="dashicons dashicons-update"></span> Deactivating..';
          // request completed?
      ...
      function activate(url) {
        ...
        xhr.onreadystatechange = function () {
          ...
          kemet_active_plugin.innerHTML =
            '<span class="dashicons dashicons-update"></span> Activating..';
          // request completed?
          if (xhr.readyState !== 4) return;
      ...
      function install_and_activate(url) {
        ...
        xhr.onreadystatechange = function () {
          ...
          kemet_active_plugin.innerHTML =
            '<span class="dashicons dashicons-update"></span> Installing..';
          // request completed?
          if (xhr.readyState !== 4) return;
